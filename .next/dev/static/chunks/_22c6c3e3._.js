...
"[project]/contexts/tasks-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TasksProvider({ children }) {
    ...
    const getUpcomingTasks = (days = 7)=>{
        ...
        return tasks.filter((task)=>!task.completed && task.dueDate >= today && task.dueDate <= futureDateStr).sort((a, b)=>a.dueDate.localeCompare(b.dueDate) || a.dueTime.localeCompare(b.dueTime));
    };
    // NUEVAS FUNCIONES PARA PROFESORES
    const addGroupTask = (task)=>{
        const newTask = {
            ...task,
            id: Math.random().toString(36).substr(2, 9),
            createdAt: new Date().toISOString(),
    ...
    const getGroupTasks = (teacherEmail)=>{
        return tasks.filter((task)=>task.createdBy === teacherEmail && task.isGroupTask).sort((a, b)=>new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime());
    };
    const getStudentTasks = (studentEmail)=>{
        return tasks.filter((task)=>task.isGroupTask && task.assignedTo.includes(studentEmail) && !task.completed).sort((a, b)=>a.dueDate.localeCompare(b.dueDate));
    };
    const markTaskAsSubmitted = (taskId, studentEmail)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TasksContext.Provider, {
        ...
        fileName: "[project]/contexts/tasks-context.tsx",
        lineNumber: 165,
        columnNumber: 5
    }, this);
}
_s(TasksProvider, "weOf0VesAdD4xw+rXOOhYK4d8/M=");
_c = TasksProvider;
function useTasks() {
    _s1();
...
//# sourceMappingURL=_22c6c3e3._.js.map